...
(1, 'Dilip', 'admin', 7096587150, 'tarkhaladilip18@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2023-08-19 11:38:32');
...
-- Create the tblamenities table
CREATE TABLE `tblamenities` (
  `ID` int(10) NOT NULL,
  `AmenityName` varchar(200) DEFAULT NULL,
  `AmenityDescription` mediumtext DEFAULT NULL,
  `AmenityImage` varchar(200) DEFAULT NULL,
  `CreationDate` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Insert data into the tblamenities table
INSERT INTO `tblamenities` (`ID`, `AmenityName`, `AmenityDescription`, `AmenityImage`, `CreationDate`) VALUES
(1, 'Swimming Pool', 'Our swimming pool is the perfect place to cool off and enjoy a refreshing swim on a hot day.', 'swimming_pool.jpg', '2022-08-19 10:00:00'),
(2, 'Playground', 'Our playground is equipped with swings, slides, and other fun equipment for children to enjoy.', 'playground.jpg', '2022-08-19 10:00:00'),
(3, 'Picnic Area', 'Our picnic area is a great place to relax and have a picnic with your family and friends.', 'picnic_area.jpg', '2022-08-19 10:00:00');
...
(2, 'contactus', 'Contact Us', 'Ashtha, court to airport road keshod', 'tarkhaladilip18@gmail.com', 7096587150, '2020-08-12 02:59:43');
