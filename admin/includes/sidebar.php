   <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <p style="color: white">ADMIN PORTAL</p>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-folder"></i><span>Other Amenities</span></a>
                                <ul class="collapse">
                                    <li><a href="add-amenity.php">Add Amenity</a></li>
                                    <li><a href="manage-amenities.php">Manage Amenities</a></li>
                                </ul>
                            </li>
                            <li>
